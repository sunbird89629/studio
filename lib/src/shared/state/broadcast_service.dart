...
class BroadcastService {
  ...
  final Set<TerminalBroadcastParticipant> _participants = {};

  /// Whether [plugin] is currently in the broadcast group.
  bool isParticipant(TerminalBroadcastParticipant plugin) =>
      _participants.contains(plugin);

  /// Number of terminals currently in the broadcast group.
  int get participantCount => _participants.length;

  /// Adds [plugin] to the broadcast group.
  void register(TerminalBroadcastParticipant plugin) {
    _participants.add(plugin);
  }

  /// Removes [plugin] from the broadcast group.
  void deregister(TerminalBroadcastParticipant plugin) {
